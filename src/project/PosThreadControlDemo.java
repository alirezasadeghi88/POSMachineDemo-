...
public class PosThreadControlDemo {
    public static void main(String[] args) {
        ...
        bankAuthThread.setPriority(Thread.MAX_PRIORITY);       // [BANK] حیاتی‌ترین نخ
        receiptPrinterThread.setPriority(Thread.NORM_PRIORITY); // [PRINT] اولویت متوسط
        inventoryUpdateThread.setPriority(Thread.MIN_PRIORITY); // [INV] کم‌اهمیت‌تر
        ...
        try {
            bankAuthThread.join();
            receiptPrinterThread.join(); // رسید باید آماده شود
